...
const icons = [
    ...
    { key: 'html', alt: 'HTML', active: false, text: 'HTML', projects: ['darkSlider', 'food', 'childhood', 'glopt', 'ikea', 'kinomonstrHtml', 'naturalForest', 'prengi', 'pulse', 'quizlanding', 'SaintCode-DoDo', 'SaintCode-Konstruct', 'SaintCode-Novik', 'sar', 'Smith', 'tattoo', 'freelance', 'uber', 'visit-card', 'wordpress'] },
    { key: 'css', alt: 'CSS', active: false, text: 'CSS', projects: ['3dCard', 'darkSlider', 'gallery', 'beautifulWorld', 'food', 'architect', 'fairyForest', 'childhood', 'glopt', 'ikea', 'jewelery', 'naturalForest', 'prengi', 'pulse', 'quizlanding', 'result.school', 'SaintCode-DoDo', 'SaintCode-Emoji', 'SaintCode-Konstruct', 'SaintCode-Novik', 'sar', 'Smith', 'tattoo', 'freelance', 'uber', 'visit-card', 'wordpress'] },
